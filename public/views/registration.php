<section class="conteiner container-form ">
    <div class="display-form">
        ...
        <form class="content-form" method="POST" onsubmit="return validateFormRegistration()">
            <label class="text-input-form label-login">Введите логин</label>
            <input id="login" type="text" class="input-form" placeholder="login">
            <label class="text-input-form label-password">Введите пароль</label>
            <input id="password" type="password" class="input-form" placeholder="password">
